...
import { BarChart3, TrendingUp, Users, Clock, Target, Activity, Calendar, Filter } from 'lucide-react'
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Süreç performansınızı ve kullanım istatistiklerinizi takip edin</p>
      </div>
